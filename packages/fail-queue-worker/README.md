...
Fail Queue worker is a background process that runs against a queue of failed migrations. Its main purpose it to re-run the failed migration.

## Dependencies

Fail Queue worker uses a number of projects and dependencies to work properly:
...
git clone https://github.com/Kuunika/dhis2-fail-queue-worker.git

# navigate to the project root directory
cd dhis2-fail-queue-worker
```
